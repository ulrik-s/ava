...
const DUMMY_PREVIEW_CONTEXT = {
  ...
  organization: {
    ...
    bankgiro: "123-4567",
    mainOffice: { name: "Stockholm", address: "Storgatan 1, 111 23 Stockholm", phone: "08-123 456 78", email: "info@advokat.se", isMain: true },
    offices: [
      { name: "Stockholm", address: "Storgatan 1, 111 23 Stockholm", phone: "08-123 456 78", email: "info@advokat.se", isMain: true },
      { name: "Göteborg", address: "Avenyn 10, 411 36 Göteborg", phone: "031-987 65 43", email: "gbg@advokat.se", isMain: false },
    ],
  },
  klient: {
    name: "Anna Svensson",
    personalNumber: "19800101-1234",
    address: "Hemgatan 5, 112 34 Stockholm",
    phone: "070-123 45 67",
  ...
  motpart: {
    name: "Bo Lindqvist",
    personalNumber: "19750505-5678",
    address: "Motgatan 10, 113 45 Stockholm",
    phone: "070-987 65 43",
  ...
  timeEntries: [
    { date: "2024-03-01", description: "Möte med klient", minutes: 60, hours: "1,0 tim", amount: 250000, userName: "Erik Advokat", billable: true },
    { date: "2024-03-05", description: "Upprättande av avtal", minutes: 120, hours: "2,0 tim", amount: 500000, userName: "Erik Advokat", billable: true },
  ],
  expenses: [
    { date: "2024-03-02", description: "Resekostnad", amount: 15000, userName: "Erik Advokat", billable: true },
  ],
  totalTimeMinutes: 180,
  totalTimeAmount: 750000,
