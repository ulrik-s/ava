...
export default defineConfig({
  ...
  testMatch: /(column-menu|matter-watch|demo-invoice-document|demo-kostnadsrakning-verdict|demo-login|demo-smoke|kebab-verify|matters-employee-filter)\.spec\.ts$/,
  timeout: 90_000,
