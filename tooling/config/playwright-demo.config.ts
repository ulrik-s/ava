...
export default defineConfig({
  ...
  testMatch: /(column-menu|chrome-regressions|matter-watch|demo-invoice-document|demo-kostnadsrakning-verdict|demo-login|demo-smoke|kebab-verify|matters-employee-filter|docking-layout)\.spec\.ts$/,
  timeout: 90_000,
